...
#
#    Cmdline:
#        sokol-shdc -i bufferoffsets.glsl -f sokol_nim -o bufferoffsets.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
...
#        Fragment Shader: fs
#        Attributes:
#            attrBufferoffsetsPosition => 0
#            attrBufferoffsetsColor0 => 1
#    Bindings:
#
const attrBufferoffsetsPosition* = 0
const attrBufferoffsetsColor0* = 1
#
#    #version 430
#
...
proc bufferoffsetsShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "bufferoffsets_shader")
    case backend:
        of backendGlcore:
