...
#
#    Cmdline:
#        sokol-shdc -i examples/shaders/noninterleaved.glsl -o examples/shaders/noninterleaved.nim -l glsl430:metal_macos:hlsl5:glsl300es -f sokol_nim
#
#    Overview:
#    =========
...
proc noninterleavedShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result.label = "noninterleaved_shader"
    case backend:
        of backendGlcore:
