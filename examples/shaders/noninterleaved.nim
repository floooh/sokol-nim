...
#
#    Cmdline:
#        sokol-shdc -i noninterleaved.glsl -f sokol_nim -o noninterleaved.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
...
#        Fragment Shader: fs
#        Attributes:
#            attrNoninterleavedPosition => 0
#            attrNoninterleavedColor0 => 1
#    Bindings:
#        Uniform block 'vs_params':
#            Nim struct: VsParams
#            Bind slot: ubVsParams => 0
#
const attrNoninterleavedPosition* = 0
const attrNoninterleavedColor0* = 1
const ubVsParams* = 0
...
proc noninterleavedShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "noninterleaved_shader")
    case backend:
        of backendGlcore:
