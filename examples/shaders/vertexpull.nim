...
#
#    Cmdline:
#        sokol-shdc -i examples/shaders/vertexpull.glsl -o examples/shaders/vertexpull.nim -l glsl430:metal_macos:hlsl5:glsl300es -f sokol_nim
#
#    Overview:
#    =========
...
#
#
const vsSourceMetalMacos: array[617, uint8] = [
...
proc vertexpullShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    ...
    case backend:
        of backendGlcore:
            ...
            result.vs.storageBuffers[0].used = true
            result.vs.storageBuffers[0].readonly = true
