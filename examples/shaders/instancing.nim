...
#
#    Cmdline:
#        sokol-shdc -i instancing.glsl -f sokol_nim -o instancing.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
...
#        Attributes:
#            attrInstancingPos => 0
#            attrInstancingColor0 => 1
#            attrInstancingInstPos => 2
#    Bindings:
#        Uniform block 'vs_params':
#            Nim struct: VsParams
#            Bind slot: ubVsParams => 0
#
const attrInstancingPos* = 0
const attrInstancingColor0* = 1
const attrInstancingInstPos* = 2
const ubVsParams* = 0
...
#
#
const vsSourceGlsl430: array[335, uint8] = [
...
#
#
const vsSourceGlsl300es: array[317, uint8] = [
...
#    }
#
const vsSourceHlsl5: array[842, uint8] = [
...
#
#
const vsSourceMetalMacos: array[564, uint8] = [
...
proc instancingShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "instancing_shader")
    case backend:
        of backendGlcore:
            ...
            result.attrs[2].glslName = "inst_pos"
