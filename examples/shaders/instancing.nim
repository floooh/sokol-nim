...
#
#    Cmdline:
#        sokol-shdc -i examples/shaders/instancing.glsl -o examples/shaders/instancing.nim -l glsl430:metal_macos:hlsl5:glsl300es -f sokol_nim
#
#    Overview:
#    =========
...
proc instancingShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result.label = "instancing_shader"
    case backend:
        of backendGlcore:
