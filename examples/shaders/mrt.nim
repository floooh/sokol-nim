...
#
#    Cmdline:
#        sokol-shdc -i mrt.glsl -f sokol_nim -o mrt.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
#    Shader program: 'dbg':
...
proc dbgShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "dbg_shader")
    case backend:
        of backendGlcore:
...
proc fsqShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "fsq_shader")
    case backend:
        of backendGlcore:
