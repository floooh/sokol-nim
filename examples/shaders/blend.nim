...
#
#    Cmdline:
#        sokol-shdc -i blend.glsl -f sokol_nim -o blend.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
#    Shader program: 'bg':
...
proc bgShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "bg_shader")
    case backend:
        of backendGlcore:
...
proc quadShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "quad_shader")
    case backend:
        of backendGlcore:
