...
#
#    Cmdline:
#        sokol-shdc -i shapes.glsl -f sokol_nim -o shapes.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
...
#
#
const vsSourceGlsl430: array[621, uint8] = [
...
#
#
const vsSourceGlsl300es: array[603, uint8] = [
...
#    }
#
const vsSourceHlsl5: array[1238, uint8] = [
    ...
    0x39,0x5f,0x64,0x72,0x61,0x77,0x5f,0x6d,0x6f,0x64,0x65,0x20,0x3a,0x20,0x70,0x61,
...
proc shapesShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "shapes_shader")
    case backend:
        of backendGlcore:
            ...
            result.attrs[3].baseType = shaderAttrBaseTypeFloat
