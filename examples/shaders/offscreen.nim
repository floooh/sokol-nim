...
#
#    Cmdline:
#        sokol-shdc -i offscreen.glsl -f sokol_nim -o offscreen.nim -l glsl430:metal_macos:hlsl5:glsl300es
#
#    Overview:
#    =========
...
proc defaultShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "default_shader")
    case backend:
        of backendGlcore:
            ...
            result.attrs[0].baseType = shaderAttrBaseTypeFloat
            result.attrs[0].glslName = "position"
            result.attrs[1].baseType = shaderAttrBaseTypeFloat
            result.attrs[1].glslName = "normal"
            result.attrs[2].baseType = shaderAttrBaseTypeFloat
...
proc offscreenShaderDesc*(backend: sg.Backend): sg.ShaderDesc =
    result = sg.ShaderDesc(label: "offscreen_shader")
    case backend:
        of backendGlcore:
