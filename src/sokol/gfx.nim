...
type
  LogItem* {.size:sizeof(int32).} = enum
    ...
    logitemValidateBeginpassColorattachmentviewSamplecount,
    logitemValidateBeginpassColorattachmentviewSamplecountsEqual,
    ...
    logitemValidateDrawWriteBufferTransientMissing,
    logitemValidateDrawWriteImageTransientMissing,
